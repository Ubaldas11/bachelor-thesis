...
\subsection{Pritaikymas skaitmeninės tapatybės valdyme}
...
apribojant skaitymo/rašymo teises skirtingiems mazgams bei blokų grandinėje nesaugant itin jautrių duomenų (pvz. asmens kodo).
...
įveikti kontrolės, pasitikėjimo trūkumo bei vienintelio nesekmės taško iššūkius.
