...
Šiame skyriuje vertinamas~\ref{section:BCIDM} skyriuje pristatytas blokų grandine paremtas tapatybės atributų
...
\tocless\subsubsection{Tapatybės atributai decentralizuoti}
...
\tocless\subsubsection{Sumažintas reikiamas pasitikėjimas trečiosioms šalims}
