...
, kreipiasi į blokų grandinės išmanųjį kontraktą (žr.~\ref{fig:askForAttributeSequence} pav.).
...
A paslaugai P. (žr.~\ref{fig:givePermissions} pav.). Blokų grandinė asmeniui leidžia autorizuoti tik savo naudojamas paslaugas
