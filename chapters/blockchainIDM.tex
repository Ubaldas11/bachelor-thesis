...
\tocless{\subsubsection{Išmanieji kontraktai paslaugų autorizavimo logikai} \label{BCIDM:blockchainFunctions}}
...
\tocless{\subsubsection{Atributų valdymo programa}}
...
\tocless{\subsubsection{Paslaugų registras} \label{BCIDM:serviceRegister}}
...
\tocless{\subsubsection{Naudotojo adreso suteikimas paslaugai}}
...
\tocless{\subsubsection{Paslaugos atliekama atributo užklausa} \label{BCIDM:askForAttribute}}
...
\tocless{\subsubsection{Naudotojo atliekamas paslaugos autorizavimas}}
...
\tocless{\subsubsection{Atributų valdymo programos atliekamas blokų grandinės stebėjimas} \label{BCIDM:blockchainMonitoring}}
