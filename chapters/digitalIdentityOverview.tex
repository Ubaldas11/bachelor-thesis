...
identifikatorių, kurį gali naudoti skirtingų paslaugų tiekėjų tinklalapiuose. Žemiau pateikiama schema, vaizduojanti
...
Kadangi jungtiniame tapatybės valdyme vyksta duomenų apsikeitimas tarp tapatybės tiekėjo bei paslaugų tiekėjo, jam formalizuoti
sukurti technologiniai standartai. Trys labiausiai paplitę protokolai: \textit{SAML}, \textit{OAuth} bei \textit{OpenID}. Šių technologijų
...
Atsižvelgus į technologijų savybes, galima išskirti jų pagrindinius panaudos atvejus. SAML 2.0 dažniausiai naudojamas korporacijų viduje vienkartiniam prisijungimui
