...
\subsection{Naudotojų problemų tapatybės valdyme apibendrinimas}
...
\begin{itemize}
    ...
    \item naudotojų kontrolės trūkumas. Asmenys dažnai priversti suvesti daugybę tapatybės duomenų registruodamiesi, kurių nebūtinai
